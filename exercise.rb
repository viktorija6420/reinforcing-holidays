...
edi_cohort=Cohort.new(Date.new(2017,07,31))
print edi_cohort.coffee_code_day?(Date.new(2017,8,23))
print edi_cohort.coffee_code_week?(Date.new(2017,8,23))
print edi_cohort.class_days
print edi_cohort.weeks_of_cohort
print edi_cohort.last_day
print edi_cohort.no_lecture_on(Date.new(2017,8,31))
print edi_cohort.double_check_holiday(Date.new(2017,8,31))
